...
```
2. Hyperparameter
  - _Edit only if helper function is not producing the right output. Alert me if you have to edit this._
  - _You must include this code to use the helper function._
```
...
```
4. Optional Arguments (for fine-tuning of output)
  - _If you wish to include some of these keyword arguments, edit what is on the right of the `=` and add them at the back of your input._
```
#                           title.font_size = 1
